                         ...
                         <form action="" method="POST" enctype="multipart/form-data">
                              <div class="row mb-3">
                                   <input type="hidden" name="id_pemesanan" id="id_pemesanan"
                                        value="<?= $pemesananid['id_pemesanan']; ?>">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="text" name="no_pemesanan" id="no_pemesanan" class="form-control"
                                             value="<?= $pemesananid['no_pemesanan']; ?>" readonly>
                                   </div>
                              </div>
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="text" name="no_registrasi" id="no_registrasi" class="form-control"
                                             value="<?= $pemesananid['no_registrasi']; ?>" readonly>
                                   </div>
                              </div>
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="date" name="tanggal_pemesanan" id="tanggal_pemesanan"
                                             class="form-control" value="<?= $pemesananid['tanggal_pemesanan']; ?>"
                                             readonly>
                                   </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="text" name="kode_jadwal" id="kode_jadwal" class="form-control"
                                             value="<?= $pemesananid['kode_jadwal']; ?>" readonly>
                                   </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="number" name="harga" id="harga" onclick="sum();"
                                             class="form-control" value="<?= $pemesananid['harga']; ?>" readonly>
                                   </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="number" name="telah_bayar" id="telah_bayar" onclick="sum();"
                                             class="form-control" value="<?= $pemesananid['telah_bayar']; ?>" readonly>
                                   </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                        <input type="number" name="sisa" id="sisa" class="form-control"
                                             value="<?= $pemesananid['sisa']; ?>" readonly>
                                   </div>
                              </div>
                                   ...
                                   <div class="col-sm-10">
                                        <select name="status" id="status" class="form-control">
                                             ...
                                             <option value="Belum Lunas"
                                                  <?= $status == 'Belum Lunas' ? 'selected' : null ?>>Belum Lunas
                                             </option>
                                             <option value="Lunas" <?= $status == 'Lunas' ? 'selected' : null ?>>Lunas
                                             </option>
                                        </select>
                                   </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                   <div class="col-sm-10">
                                        <button type="submit" name="btn_simpan" id="btn_simpan"
                                             class="btn btn-primary">Update Pesanan</button>
                                   </div>
                              </div>
