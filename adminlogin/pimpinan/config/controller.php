...
function update_jadwal($post)
{
    ...
    $query = "UPDATE jadwal SET kode_jadwal='$kode_jadwal', kode_paket = '$kode_paket', harga = '$harga', isi_kamar = '$isi_kamar', tanggal_keberangkatan = '$tanggal_keberangkatan', nopesawat = '$nopesawat', tanggal_kepulangan = '$tanggal_kepulangan', kuota_pendaftaran = '$kuota_pendaftaran' WHERE id_jadwal = '$id_jadwal'";
