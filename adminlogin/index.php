                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">                       
                            ...
                            <img src="assets/img/<?= $user['foto'] ?>" alt="Profile" class="rounded-circle"><br/>
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo $_SESSION['tempat_lahir'] ?>, <?php echo date('d-M-Y', strtotime($user['tanggal_lahir'])); ?></div>
                                    </div>
